...
contract ESSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 900,000 ESShare
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 450000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION =  405000 ether;
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 0 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 45000 ether;
    ...
    ) public ERC20("Fi  esShare", "esShare") {
