...
contract SHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 1,000,000 Share
    uint256 public constant ESCONVERT_POOL_ALLOCATION = 900000 ether;
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 50000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 45000 ether;
     ...
     */
    function distributeReward(address _farmingIncentiveFund,address _convertPoolAddress)
        external
        onlyOperator
    {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_farmingIncentiveFund != address(0) && _convertPoolAddress!=address(0), "!_farmingIncentiveFund");
        rewardPoolDistributed = true;
        _mint(_farmingIncentiveFund, FARMING_POOL_REWARD_ALLOCATION);
        _mint(_convertPoolAddress, ESCONVERT_POOL_ALLOCATION);
    }
