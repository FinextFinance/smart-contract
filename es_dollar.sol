...
//  Finance
contract ESDollar is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 180000 ether; // 180000 of tokens
     ...
     */
    constructor() public ERC20("esNa Fn", "esDo") {
